...
def generate_fake_data(conn: duckdb.DuckDBPyConnection, num_customers: int = 100, num_products: int = 50, num_orders: int = 500):
    ...
    for i in range(1, num_orders + 1):
        ...
        order_timestamp = datetime.combine(order_date, datetime.min.time()) + timedelta(hours=random.randint(8, 22))
